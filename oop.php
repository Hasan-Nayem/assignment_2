...
class Book {
    ...
    public function borrowBook() {
        if ($this->availableCopies > 0) {
            ...
            echo "Book '{$this->title}' borrowed successfully.</br>";
        } else {
            echo "Sorry, '{$this->title}' is currently not available for borrowing.</br>";
        }
    }

    public function returnBook() {
        $this->availableCopies++;
        echo "Book '{$this->title}' returned successfully.</br>";
    }
}
